...
export default async function(ctx){
  ...
  var AC={
    ...
    folk :"#D8B97B",   // 莫奈暖赭
    intl :"#95A5C3",   // 莫奈雾蓝
    dim  :"rgba(74,85,104,0.65)",
    faint:"rgba(74,85,104,0.35)",
    sep  :"rgba(74,85,104,0.15)",
  };

  // ── 节日胶囊 ───
  function chip(name, days, accent){
    var today0=days===0;
    var nameColor=today0?"rgba(74,85,104,0.95)":AC.dim;
    var daysLabel=today0?"今天":days+"天";
    var daysColor=today0?accent:"rgba(74,85,104,0.45)";
    return row([
      ...
      gap:3,
      padding:[3,7,3,7],
      backgroundColor: today0?(accent+"33"):"rgba(74,85,104,0.06)",
      borderRadius:7,
    });
  }
  ...
  // 公历信息放到左侧，移除原本的 alignItems:"end" 使其默认靠左对齐
  var headerLeft = col([
    row([
      ic("calendar", 12, "rgba(74,85,104,0.50)"),
      t((now.getMonth()+1)+"月"+now.getDate()+"日", 15, "semibold", "#4A5568"),
    ],{gap:3}),
    t("星期"+wkCN+"   "+astro, 10, "regular", "rgba(74,85,104,0.70)"),
    t(gzLine, 9, "regular", "rgba(74,85,104,0.45)"),
  ],{gap:2});

  // 农历信息放到右侧，新增 alignItems:"end" 使其靠右对齐
  var headerRight = col([
    t(lunarDay, 26, "bold", "#4A5568"),
    row([
  ...
  return {
    ...
    backgroundGradient:{
    type:"linear",
    colors:["#FDFBF7", "#E4EBDC", "#DEE5EE", "#C6D8E4"],
    stops:[0,0.35,0.7,1],
    startPoint:{x:0,y:0},
    endPoint:{x:1,y:1},
    },
